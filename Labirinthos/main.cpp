        ...
        try
        {
            ...
            for (i = 0; i < 1000; i++) 
            {
                ...
                refresh();                    // Ανανεώνει την οθόνη
                    ...
                    {
                    asimenia.move(map, grigorakis, key,ladder, trap1, trap2);
                    }

                    //Αν ο Γρηγοράκης δεν είναι παγιδευμένη τότε κουνίεται 
                    if (!grigorakis.getIsTrapped()) 
                    {
                    grigorakis.move(map, key,ladder, trap1, trap2);
                    }
                    ...
                    {
                        mvprintw(map.getRows() + 1,0, "Both heroes got trapped!\nPlease press a key to continue...");
                        map.print();
                        refresh();
                        getch();
                        endwin();
                    ...
                    {
                        mvprintw(map.getRows() + 1,0, "Grigorakis, having the key, cannot escape the trap.\nPlease press a key to continue...");
                        map.print();
                        refresh();
                        getch();
                        endwin();
                    ...
                    {
                        mvprintw(map.getRows() + 1,0, "Asimenia, having the key, cannot escape the trap.\nPlease press a key to continue...");
                        map.print();
                        refresh();
                        getch();
                        endwin();
            ...
            if(i == 1000)
            {
                mvprintw(map.getRows() + 1,0,"Terminal have passed...The evil wizard Gmeles conquered the kingdom of Giounivia\nPlease press a key to continue...\n");
                map.print();
                refresh();
                getch();
                endwin();
            ...
            while(1)
            {
                ...
                {
                    mvprintw(map.getRows() + 1,0, "The Giounivia kingdom has been saved!\nPlease press a key to continue...");
                    map.print();
                    refresh();
                    getch();
                    endwin();
